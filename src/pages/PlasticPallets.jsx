...
const palletTypes = [
  ['Heavy-Duty Plastic Pallets', 'Strong reusable plastic pallets for heavy loads, warehouses, and industrial operations.', 'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?auto=format&fit=crop&w=900&q=80'],
  ['Lightweight Plastic Pallets', 'Easy-to-handle pallets for retail storage, logistics, and repeated warehouse movement.', 'https://images.unsplash.com/photo-1586528116493-da5b8f76c643?auto=format&fit=crop&w=900&q=80'],
  ['Rackable Plastic Pallets', 'Plastic pallets suitable for racking systems, storage facilities, and organized stock handling.', 'https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&w=900&q=80'],
  ['Nestable Plastic Pallets', 'Space-saving plastic pallets for efficient return logistics and compact storage.', 'https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&w=900&q=80'],
  ['Hygienic Plastic Pallets', 'Cleanable pallets for food, pharmaceutical, and hygiene-sensitive storage environments.', 'https://images.unsplash.com/photo-1581093458791-9d09ccfed1c1?auto=format&fit=crop&w=900&q=80'],
  ['Export Plastic Pallets', 'Durable pallets for export handling, cargo movement, and international supply chains.', 'https://images.unsplash.com/photo-1580674285054-bed31e145f59?auto=format&fit=crop&w=900&q=80']
];
...
export default function PlasticPallets() {
  ...
  useEffect(() => {
    ...
    document.title = 'Plastic Pallets Supplier in UAE | Durable Industrial Plastic Pallets';
    description?.setAttribute('content', 'Leading plastic pallet supplier in Dubai, Sharjah, Abu Dhabi, JAFZA, and all UAE for warehouse, logistics, food, and industrial use.');
    keywords?.setAttribute('content', 'plastic pallets UAE, plastic pallet supplier Dubai, warehouse plastic pallets UAE');
  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(90deg, rgba(2, 2, 79, 0.94), rgba(22, 17, 86, 0.86), rgba(2, 6, 23, 0.62)), url('https://images.unsplash.com/photo-1565793298595-6a879b1d9492?auto=format&fit=crop&w=1800&q=80')",
      ...
      >
        <div className="mx-auto flex min-h-[620px] max-w-7xl items-center px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-6 text-4xl font-black leading-tight sm:text-5xl lg:text-7xl">Plastic Pallets Supplier in UAE</h1>
      ...
      <section className="bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <img className="min-h-96 rounded-3xl object-cover shadow-2xl shadow-slate-950/10" src="https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&w=1100&q=80" alt="Plastic pallets in industrial warehouse" />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {gallery.map((image, index) => (
              <img className="h-72 w-full rounded-3xl object-cover shadow-xl shadow-slate-950/10" src={image} alt={`Plastic pallet product ${index + 1}`} loading="lazy" key={image} />
            ))}
          </div>
        </div>
      </section>

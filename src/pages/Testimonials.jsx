        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {testimonials.map(([name, review], index) => (
              <article className="group rounded-3xl border border-slate-200 bg-white p-7 shadow-md shadow-slate-950/5 transition duration-300 hover:shadow-2xl hover:shadow-indigo-950/10" key={name}>

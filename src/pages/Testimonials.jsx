...
const whatsappUrl = `https://wa.me/971542046121?text=${encodeURIComponent('Hello, I want to work with a trusted pallet supplier in UAE.')}`;
      ...
      >
        <div className="mx-auto flex min-h-[460px] max-w-7xl items-center px-4 py-16 sm:min-h-[500px] sm:px-6 sm:py-20 lg:px-8">
          <div className="max-w-4xl">
            <span className="inline-flex rounded-full bg-indigo-500/20 px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-sky-100 ring-1 ring-white/10">Testimonials — Client Reviews</span>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {testimonials.map(([name, review], index) => (
              <article className="group rounded-none border border-slate-200 bg-white p-7 shadow-md shadow-slate-950/5 transition duration-300 hover:shadow-2xl hover:shadow-indigo-950/10" key={name}>

...
const palletTypes = [
  ['Euro Pallets', 'Standardized pallets for warehouse storage, distribution, and commercial supply chains.', 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=900&q=80'],
  ['Two-Way Pallets', 'Reliable entry pallets suitable for common forklift handling and storage operations.', 'https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&w=900&q=80'],
  ['Four-Way Pallets', 'Flexible pallet handling from all sides for efficient warehouse movement.', 'https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&w=900&q=80'],
  ['Heavy-Duty Pallets', 'Strong pallets built for heavy industrial products, machinery, and bulk loads.', 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&w=900&q=80'],
  ['Heat Treated Pallets', 'Export-ready heat-treated pallets for international shipping requirements.', 'https://images.unsplash.com/photo-1580674285054-bed31e145f59?auto=format&fit=crop&w=900&q=80'],
  ['Custom Wooden Pallets', 'Made-to-size pallet solutions according to load, dimensions, and shipping needs.', 'https://images.unsplash.com/photo-1605379399642-870262d3d051?auto=format&fit=crop&w=900&q=80']
];
...
export default function WoodenPallets() {
  ...
  useEffect(() => {
    ...
    document.title = 'Wooden Pallets Supplier in UAE | Mujahid Hussain Carpentry';
    description?.setAttribute('content', 'Premium wooden pallet manufacturer and supplier in Dubai, Sharjah, Abu Dhabi, JAFZA, and all UAE.');
    keywords?.setAttribute('content', 'wooden pallets UAE, pallet supplier Dubai, wooden pallets Sharjah, export pallets UAE');
    ...
    <>
      ...
      >
        <div className="mx-auto flex min-h-[620px] max-w-7xl items-center px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-6 text-4xl font-black leading-tight sm:text-5xl lg:text-7xl">Premium Wooden Pallets Supplier in UAE</h1>
      ...
      <section className="bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <img className="min-h-96 rounded-3xl object-cover shadow-2xl shadow-slate-950/10" src="https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&w=1100&q=80" alt="Wooden pallets in warehouse" />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {gallery.map((image, index) => (
              <img className="h-72 w-full rounded-3xl object-cover shadow-xl shadow-slate-950/10" src={image} alt={`Wooden pallet product ${index + 1}`} loading="lazy" key={image} />
            ))}
          </div>
        </div>
      </section>

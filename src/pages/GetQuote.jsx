    ...
    <>
      <section className="bg-slate-950 px-4 py-16 text-center text-white sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="mt-3 text-4xl font-black sm:text-5xl">Get instant pricing for pallets, crates, and jumbo bags</h1>
          <p className="mt-5 text-base leading-8 text-slate-300">Send product type, size, quantity, and delivery location for custom pricing.</p>
        </div>
      </section>
